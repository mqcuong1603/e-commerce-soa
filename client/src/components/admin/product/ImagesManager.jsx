        ...
        <div className="mb-3">
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <div className="d-flex gap-2">
              ...
              <Button
                ...
                active={dragEnabled}
              >
                <i className="bi bi-arrows-move me-1"></i> Reorder
              </Button>
              ...
              >
                <i className="bi bi-cloud-upload me-1"></i> Upload Images
              </Button>
          ...
          {viewMode === "variant" && variants.length > 0 && (
            <Form.Group className="mb-3">
              <Form.Label>Select Variant for Images</Form.Label>
              <Form.Select
              ...
              <Form.Text className="text-muted">
                Each variant can have its own specific images in addition to the
            ...
            <div className="d-flex">
              ...
              <div>
                ...
                <ul className="mb-0 mt-1">
                  ...
                  <li>
                    Each variant can have its own specific images to highlight
                    unique features.
                  </li>
                  <li>At least one main image is required for the product.</li>
                </ul>
              </div>
            </div>
          </Alert>
        ...
        {filteredImages.length === 0 ? (
          <Card className="bg-light text-center p-5">
            <div className="py-5">
              ...
              <h5 className="fw-bold mb-2">No Images</h5>
              ...
              {viewMode === "variant" && selectedVariant && (
                <p className="text-muted mb-4">
                  This variant doesn't have any specific images yet. You can add
                  variant-specific images or use the general product images.
                </p>
              )}
                          ...
                          <Card className="h-100 shadow-sm">
                            <div className="position-relative">
                              ...
                              {image.isMain && (
                                ...
                                >
                                  Main {image.variantId ? "Variant" : "Product"}
                                </Badge>
                              )}
                              {image.variantId && (
                                <OverlayTrigger
                            ...
                            <Card.Body className="p-2">
                              ...
                              <div className="d-flex gap-2 flex-wrap justify-content-between">
                                ...
                                <div className="ms-auto d-flex gap-1">
                                  {/* Associate with variant button - only for product images */}
                                  {!image.variantId && variants.length > 0 && (
                                    <OverlayTrigger
                                      placement="top"
                                      overlay={
                                        <Tooltip>
                                          Link this image to a specific variant
                                        </Tooltip>
                                      }
                                    >
                                      <Button
