      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              ...
              components and tech products. We offer a wide range of products
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link to="/category/laptops" className="hover:text-white">
                  Laptops
                </Link>
              </li>
              <li>
                <Link to="/category/monitors" className="hover:text-white">
                  Monitors
                </Link>
              </li>
              <li>
                <Link to="/category/storage" className="hover:text-white">
                  Storage
                </Link>
              </li>
              <li>
                <Link to="/category/processors" className="hover:text-white">
                  Processors
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/category/motherboards" className="hover:text-white">
                  Motherboards
                </Link>
              </li>
              <li>
                <Link to="/category/ram" className="hover:text-white">
                  RAM
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8 mb-8">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-gray-400 mb-4 text-center">
              Get the latest news, promotions, and updates directly to your
              inbox.
            </p>
            <form className="flex">
              <input
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          ...
          <div className="mt-2">
            ...
            <Link to="/terms-of-service" className="hover:text-white mr-4">
              Terms of Service
            </Link>
